...
import { Check, Home, Users, Shield, FileCheck, Percent, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <span className="text-[#09391C] font-medium">For Landlords</span>
          </nav>
        </motion.div>
          ...
          <div className="relative bg-gradient-to-br from-[#09391C] via-[#0B423D] to-[#0A4A3C] px-6 sm:px-10 lg:px-16 py-12 sm:py-16">
            ...
            <motion.div variants={itemVariants} className="relative z-10">
              ...
              <p className="text-lg sm:text-xl text-[#D6DDEB] max-w-2xl leading-relaxed">
                List your property for sale, rent, shortlet, or joint venture. Add details easily and reach more serious buyers.
              </p>
            </motion.div>
          </div>
          ...
          <div className="px-6 sm:px-10 lg:px-16 py-10 sm:py-12">
            ...
            >
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-gray-500 mt-1">Properties Listed</div>
              </div>
              <div className="text-center border-x border-gray-100">
                <div className="text-2xl sm:text-3xl font-bold text-[#09391C]">200+</div>
                <div className="text-xs sm:text-sm text-gray-500 mt-1">Verified Agents</div>
              </div>
              <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Get started in minutes — it&apos;s free to list.
                  </p>
                </div>
                <Link
                  href="/landlord_page"
        ...
        >
          ...
          >
            ...
            <h3 className="font-semibold text-[#09391C] mb-2">Multiple Agents</h3>
            <p className="text-sm text-gray-500">
              Let multiple agents promote your listing for maximum exposure.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-semibold text-[#09391C] mb-2">Verified Documents</h3>
            <p className="text-sm text-gray-500">
              Build trust with potential buyers through document verification.
            </p>
          </motion.div>
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#8DDB90]/20 flex items-center justify-center mb-4">
              <Percent className="w-5 h-5 text-[#09391C]" />
            </div>
            <h3 className="font-semibold text-[#09391C] mb-2">Flexible Commission</h3>
            <p className="text-sm text-gray-500">
              Set your own commission rates to attract the best agents.
            </p>
          </motion.div>
        </motion.div>
      </div>
...
export default ForLandlordsShowcase;
