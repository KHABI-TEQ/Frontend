...
export const URLS = {
  ...
  professionalService: (slug: string) => `/professional-services/${slug}`,
  professionalServiceRequests: (slug: string) => `/professional-services/${slug}/requests`,
  professionalServiceRequestPay: (id: string) => `/professional-service-requests/${id}/pay`,
